...
{
    default void receiveMessage(model.ReliableMessage rmessage, ACKServicePrx prx)
    {
        receiveMessage(rmessage, prx, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void receiveMessage(model.ReliableMessage rmessage, ACKServicePrx prx, java.util.Map<String, String> context)
    {
        _iceI_receiveMessageAsync(rmessage, prx, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> receiveMessageAsync(model.ReliableMessage rmessage, ACKServicePrx prx)
    {
        return _iceI_receiveMessageAsync(rmessage, prx, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> receiveMessageAsync(model.ReliableMessage rmessage, ACKServicePrx prx, java.util.Map<String, String> context)
    {
        return _iceI_receiveMessageAsync(rmessage, prx, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_receiveMessageAsync(model.ReliableMessage iceP_rmessage, ACKServicePrx iceP_prx, java.util.Map<String, String> context, boolean sync)
    {
