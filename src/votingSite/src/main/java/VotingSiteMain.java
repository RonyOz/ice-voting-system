...
public class VotingSiteMain {
    public static void main(String[] args) throws java.lang.Exception {
        ...
        com.zeroc.Ice.Communicator communicator = com.zeroc.Ice.Util.initialize(args, "properties.cfg", extraArgs);
    ...
    private static int run(com.zeroc.Ice.Communicator communicator, Thread destroyHook, String[] args) throws java.lang.Exception {
